...
class ShoppingListAdapter (private val dataSet: ArrayList<Product>) :
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        viewHolder.quantity.text = "Quantity : "+dataSet[position].quantity.toString()
        ...
        val totalp : Float = (discountedp*dataSet[position].quantity.toInt())
        ...
        viewHolder.minusBtn.isVisible=false
        viewHolder.plusBtn.isVisible=false
        viewHolder.removBtn.isVisible=false
    }
